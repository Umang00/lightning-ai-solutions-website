...
export function TechStack() {
  ...
  const TechItem = ({ tech, keyPrefix }: { tech: string; keyPrefix: string }) => (
    <motion.div
      key={`${keyPrefix}-${tech}`}
      className="flex-shrink-0 px-4 sm:px-6 py-2.5 sm:py-4 rounded-lg bg-slate-800/50 border border-slate-700/50 hover:border-primary-blue/50 transition-all cursor-pointer"
  ...
  return (
    <section className="py-12 sm:py-16 lg:py-20 bg-primary-slate overflow-hidden">
      ...
      <div className="relative">
        <div className="absolute inset-y-0 left-0 w-16 sm:w-24 lg:w-32 bg-gradient-to-r from-primary-slate to-transparent z-10" />
        <div className="absolute inset-y-0 right-0 w-16 sm:w-24 lg:w-32 bg-gradient-to-l from-primary-slate to-transparent z-10" />

        <div className="flex overflow-hidden">
          <motion.div
            className="flex gap-4 sm:gap-6 lg:gap-8 pr-4 sm:pr-6 lg:pr-8"
            animate={{
              x: [0, -1000],
            }}
            transition={{
        ...
        <div className="flex overflow-hidden mt-4 sm:mt-6 lg:mt-8">
          <motion.div
            className="flex gap-4 sm:gap-6 lg:gap-8 pr-4 sm:pr-6 lg:pr-8"
            animate={{
              x: [-1000, 0],
