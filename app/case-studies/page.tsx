...
export const metadata = {
  ...
  description: "Real results from real AI deployments: 200% engagement boosts, 70% cost reductions, and $10,000+ monthly savings. See how we've transformed businesses with AI.",
};
